    ...
    return (
      ...
      >
        <Container>
          ...
          <Row className="justify-content-center">
            <Col lg="4" className={`pb-0 ${sharedStyles.creamBg} ${sharedStyles.figureNoMarginBottom}`}>
              <p>
                <span className={sharedStyles.bold}>Selecting Themes</span>
                <br />
                Tap the checkboxes to select themes right away + multiple themes
            ...
            <Col lg="4" className={`pb-0 ${sharedStyles.creamBg} ${sharedStyles.figureNoMarginBottom}`}>
              <p>
                ...
                <br />
                The design also allows users to unselect themes without
                navigating to the information page.
              </p>
              <div className="text-center">
                <ImageBox
            ...
            <Col lg="4" className={`pb-0 ${sharedStyles.creamBg} ${sharedStyles.figureNoMarginBottom}`}>
              <p>
                ...
                <br />
                Users could tap the right side of the row to view investment
                information and navigate back to the theme list.
              </p>
              <div className="text-center">
                <ImageBox
          ...
          <Row className="justify-content-center">
            ...
            <Col lg="8">
              <p>
                ...
                prevent them from selecting additional ones.
              </p>
              <p>
                Initially, I was focusing on error prevention. I didn't want the
                users to perform an action that would lead to an error. So, I
                designed a disabled state for the selection control component.
                As soon as the users selected the 5th theme, the remaining
                unselected checkboxes would turn into the disabled state.
              </p>
            </Col>
          </Row>
          ...
          <Row className="justify-content-center">
            <Col lg="4" className={sharedStyles.creamBg}>
              <p>
                ...
                <br />
                The outline of the checkbox changes from active (blue) to
                disabled (grey).
              </p>
              <div className="text-center">
                <ImageBox
          ...
          <Row className="justify-content-center">
            ...
            <Col lg="8">
              <p>
                Overall, Design #1 and Design #2 didn't provide sufficient
                visual cues and feedback to the users to distinguish the change
                between active &amp; disable states. Design #3 could potentially
                confuse the users and lead them to wonder why the checkboxes
                suddenly disappeared.
              </p>
              <p>
                Reflecting on the design options, I realized that error
                prevention might be more appropriate for some tasks that could
                result in severe consequences. For this scenario, providing
                feedback is more important as the users should be aware of what
                happening and why their action is prohibited.
              </p>
            </Col>
          </Row>
          ...
          <Row className="justify-content-center">
            <Col lg="8" className={sharedStyles.creamBg}>
              <p>
                I ended up discarding the disabled stated and displaying an
                alert box when the users attempt to select additional them after
          ...
          <Row className="justify-content-center">
            ...
            <Col lg="8">
              <p>
                Only 10 themes were available when Thematic Investment first
                lauched. As of now, there are 16 themes available and the list
                will likely continue to grow in the future. As a result, the
                current UI may need some modification to support a long list of
                themes. Features like searching, sorting and filtering may
                become necessary to enhance the user experience of the mobile
                app. As more themes become available, some users may experience
                a paradox of choice. Having a "smart theme" option with
