          ...
          <Col>
            ...
            <ul>
              <li>
                ...
                details are managed by store manager or beer ambassador directly
                with each craft brewery.
              </li>
              <li>
                Craft beer inventory is manually tracked with a spreadsheet.
                LCBO staff normally spend entire Monday to go through inventory
                and calculate ordering quantities by hand.
              </li>
              <li>
          ...
          <Col>
            ...
            <ul>
              ...
              <li>
                ...
                that can affect the estimation of the LCBO staff. Therefore, it
                is almost impossible to come up with an accurate number to order
                without a proper guidance.
              </li>
              <li>
                Making phone calls back and forth is very time consuming, and it
                doesn't only cause burden to LCBO staff. There are about 660
                LCBO across Ontario, so each brewer can receive hundreds of
                phone calls on Monday and the following days.
              </li>
              <li>
                Since order modification can only be made through phone calls,
                unexpected quantity or products can show up on the delivery day
                if the brewer forgets to update with the store.
              </li>
            </ul>
          </Col>
        </Row>
          ...
          <Col>
            ...
            <ul>
              <li>
                ...
                <i>
                  Asking questions is known to be an integral part of the design
                  process.
                </i>
              </li>
              Two sessions were held to capture extra pieces of information from
              LCBO store employees and craft brewers. The following are things I
              learnt from them.
              <ul>
                <li>
                ...
                <li>
                  ...
                  relized that the store ordered too many or too less.
                </li>
              </ul>
              <li>
            ...
            <ul>
              ...
              Based on my research on modern e-commerce system, there are 3 keys
              elements that exist in most of the systems:
              <ol>
